                    ...
                    <div class="accordion mt-3" id="accordionPanelsStayOpenExample">
                                ...
                                <div class="accordion-body">
                                    ...
                                    <?php else : ?>
                                        <?php foreach ($data['unit'] as $unit) : ?>
                                            <li><a href="/web/homestayUnit/detail/<?= esc($unit['homestay_id']); ?>/<?= esc($unit['unit_type']); ?>/<?= esc($unit['unit_number']); ?>"><?= esc($unit['name']); ?></a></li>
                                        <?php endforeach; ?>
                                    <?php endif; ?>
                                </div>
                            </div>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="panelsStayOpen-headingTwo">
                                <button class="accordion-button collapsed fw-bold text-dark" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseTwo" aria-expanded="false" aria-controls="panelsStayOpen-collapseTwo">
                                    Packages
                                </button>
                            </h2>
                            <div id="panelsStayOpen-collapseTwo" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingTwo">
                                <div class="accordion-body">
                                    <?php if (empty($data['package'])) : ?>
                                        <span>There no package</span>
                                    <?php else : ?>
                                        <?php foreach ($data['package'] as $package) : ?>
                                            <?php if ($package['is_custom'] == '0') : ?>
                                                <li><a href="/web/package/detail/<?= esc($package['homestay_id']); ?>/<?= esc($package['package_id']); ?>"><?= esc($package['name']); ?></a></li>
                                            <?php endif; ?>
                                        <?php endforeach; ?>
                                    <?php endif; ?>
                                </div>
                                ...
                                <div class="accordion-body">
                                    ...
                                    <?php else : ?>
                                        <?php foreach ($data['additional_amenities'] as $additional_amenities) : ?>
                                            <li><a href="/web/additionalAmenities/detail/<?= esc($additional_amenities['homestay_id']); ?>/<?= esc($additional_amenities['additional_amenities_id']); ?>"><?= esc($additional_amenities['name']); ?></a></li>
                                        <?php endforeach; ?>
                                    <?php endif; ?>
                                </div>
                            </div>
